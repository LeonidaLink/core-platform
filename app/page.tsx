    ...
    <main className="min-h-screen bg-[#280242] text-white">
      ...
      <header className="fixed top-0 left-0 right-0 z-50 flex items-center justify-between px-8 py-5 max-w-7xl mx-auto w-full">
        ...
        <div className="flex items-center space-x-4">
          <a href="https://discord.gg/Xc7mejjReX" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 border border-white/60 hover:border-white px-5 py-2.5 rounded-full text-sm font-extrabold transition bg-transparent">
      ...
      <section className="relative w-full h-[85vh] flex flex-col justify-end overflow-hidden">
        ...
        <div className="relative z-10 px-8 max-w-7xl mx-auto w-full pb-16">
          ...
          <button className="bg-[#C7E0F5] text-[#112A46] px-8 py-3.5 rounded-full font-extrabold text-base transition hover:opacity-90">
            Join the Waitlist
          </button>
        </div>
      </section>
          ...
          <div className="md:col-span-1">
            ...
            <div className="h-[420px] rounded-2xl bg-[#1E0032] flex flex-col overflow-hidden">
              ...
              <div className="p-5 flex flex-col justify-end flex-1">
                ...
                <button className="bg-[#C7E0F5] text-[#112A46] w-fit px-5 py-2 rounded-full text-sm font-extrabold transition hover:opacity-90">
                  View Map
                </button>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              <div className="h-[420px] rounded-2xl overflow-hidden relative flex flex-col justify-end">
                ...
                <div className="relative z-10 p-5 pt-16 bg-gradient-to-t from-black/70 to-transparent text-center">
                  ...
                  <button className="bg-[#0DB9FF] text-white w-fit mx-auto px-5 py-2 rounded-full text-sm font-extrabold transition hover:opacity-90">
                    Enter Forums
                  </button>
                </div>
              </div>
              ...
              <div className="h-[420px] rounded-2xl overflow-hidden relative flex flex-col justify-end">
                ...
                <div className="relative z-10 p-5 pt-16 bg-gradient-to-t from-black/70 to-transparent text-center">
                  ...
                  <button className="bg-[#545DB0] text-white w-fit mx-auto px-5 py-2 rounded-full text-sm font-extrabold transition hover:opacity-90">
                    Read Wiki
                  </button>
                </div>
              </div>
              ...
              <div className="h-[420px] rounded-2xl overflow-hidden relative flex flex-col justify-end">
                ...
                <div className="relative z-10 p-5 pt-16 bg-gradient-to-t from-black/70 to-transparent text-center">
                  ...
                  <button className="bg-[#7969EE] text-white w-fit mx-auto px-5 py-2 rounded-full text-sm font-extrabold transition hover:opacity-90">
                    View Tools
                  </button>
                </div>
              </div>
